...
- [The future of HWI](https://github.com/bitcoin-core/HWI/issues/850) - achow plans to finish MuSig2 support, make what will likely be HWI's final release, and enter minimal maintenance until a suitable replacement is ready. New device integrations and unrelated features are no longer accepted; [BHWI](https://github.com/wizardsardine/bhwi/) is identified as a promising successor.
...
- [lnp2pBot incident: conflicting BOLT11 payment hashes](https://x.com/negrunch/status/2097763741123166576) - Francisco Calderón reports that the `invoices` dependency selected the last payment hash in a request while the Lightning node used the first, allowing attackers to exploit inconsistent payment tracking. The [parser fix](https://github.com/alexbosworth/invoices/commit/b30a012c7a3d2f5df0a8175b2aba4ef6f4601cf7) shipped alongside a Node.js 22 requirement, but its changelog omitted the security change. A discussion of parser agreement, dependency monitoring, and communicating urgent fixes.
...
- [Bitcoin is finally money again](https://x.com/stutxo/status/2097092420840329273) - Stu's BLAKE2b video.
