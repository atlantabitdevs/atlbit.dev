...
- [Voltage deprecates self-serve to focus on enterprise Lightning infrastructure](https://x.com/voltage_cloud/status/2072721707194786042?s=20) - Voltage says it is sunsetting its self-serve product and going all-in on enterprise-grade Lightning infrastructure.
