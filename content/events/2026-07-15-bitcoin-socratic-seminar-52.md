...
- [Input-triggered transaction expiry](https://delvingbitcoin.org/t/input-triggered-transaction-expiry/2667) - A relay-safe expiry primitive built around `nSequence` and `nLockTime`, with potential applications to mempool-free HTLC forwarding and pseudo contract-level relative timelocks.
